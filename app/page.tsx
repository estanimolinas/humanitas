...
export default function Inicio() {
  return (
    <main className="contenedor flex flex-1 flex-col gap-5">
      ...
      <p className="max-w-[60ch] text-pretty text-texto-2">
        Humanitas no cobra comisión ni intermedia el dinero. El acuerdo es entre vecinos.
      </p>

      <div className="aviso max-w-[60ch]">
        La lista se está armando. En unos días vas a ver las publicaciones acá.
      </div>

      <Link href="/alta" className="boton-principal boton-suelto">
        Crear mi cuenta
      </Link>

      <Link href="/terminos" className="text-texto-2 underline sm:self-start">
        Términos de uso
      </Link>
    </main>
  );
